...
package com.hongseokandrewjang.android.banthing.AnimationClasses.Swipe;
...
/*
I got this class from github and modified with it to fit recyclerview
 */
...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
     ...
     */
    public SwipeDismissListViewTouchListener(RecyclerView recyclerView, DismissCallbacks callbacks) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mDownView != null) {
                    ...
                    mDownPosition = recyclerView.getChildLayoutPosition(mDownView);
